...
const {registrer, handleRegistrer} = useForm();
...
<form className="row g-3 m-3 p-3" onSubmit={ handleRegistrer(enviar)}>
...
<form>
        <input
          style={{ marginTop: 20, marginLeft: "230" }}
          type="text"
          placeholder="Ingresa tu Nombre"
        ></input>

        <input
          style={{ marginTop: 20, marginLeft: "230", marginBottom: 20 }}
          type="email"
